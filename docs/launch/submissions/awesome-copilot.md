...
consumes scanner evidence through 13 adapters (Semgrep, Trivy, OSV, Gitleaks, ZAP, Nuclei, Playwright,
...
- [ ] **C-5.** Every number in the submission matches the tagged tree: 546 hypotheses, 21 families,
      26 lenses, 17 roles, 16 JSON contracts, 13 adapters, 18 Gold Check Packs, 38 fixtures / 76 cases,
