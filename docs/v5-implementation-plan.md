...
SecHelix now has a deterministic LOCAL benchmark for four paired dynamic proof
families: one-step state transitions, duplicate payment/refund effects,
cross-entity money-flow idempotency, and multi-step workflow prerequisite
enforcement. Every family has one intentionally vulnerable fixture and one clean sibling.
