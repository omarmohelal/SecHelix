...
| Business logic | Race/idempotency, stateful webhook replay, one-step forbidden state-transition, and bounded payment duplicate-effect proofs shipped | Add multi-step workflow fixtures and cross-entity money invariants |
