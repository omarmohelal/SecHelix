...
| External scanners | Semgrep, curated JWT/session scout, Gitleaks and Trivy run through the gateway; controlled bundle and isolated single-scanner blind ablations are measurable | Finish dependency audit/runtime image pinning and run repeated isolated scanner trials |
...
Next focus is broader full-workflow cost/time measurement and remaining runtime
