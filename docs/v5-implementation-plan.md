...
| Business logic | Race/idempotency, stateful webhook replay, and one-step forbidden state-transition proofs shipped | Add payment invariants and multi-step workflow fixtures |
