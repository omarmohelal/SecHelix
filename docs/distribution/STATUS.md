...
| claudedirectory.org (tmcpa/claudedirectory) | [PR #166](https://github.com/tmcpa/claudedirectory/pull/166) (curated plugin entry) | PR | OPEN | opened 2026-09-15; `npm run build` passes | maintainer review; merges land in batches (last 2026-08-25); Vercel preview awaits maintainer authorization, as on every fork PR | wait | yes | no |
