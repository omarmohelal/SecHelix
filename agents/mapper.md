---
name: surface-mapper
description: Map architecture, trust boundaries, entry points, privileged roles, data stores and external providers. Produce evidence, no final vulnerabilities.
---
